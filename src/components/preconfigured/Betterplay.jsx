...
import BetterplayBackgroundImage from '../../images/spendenanzeige_betterplay.png'

export const Betterplay = (props) => {

  const id = props.match.params.id
  const params = new URLSearchParams(props.location.search)
  const demo = params.has('demo') ? '&demo=true' : ''

  return <DisplayContainer backgroundImage={BetterplayBackgroundImage}>
    <DataContainer>
      <DataBlock>
